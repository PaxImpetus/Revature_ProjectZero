...
object Constants{
    ...
    val smallTableForm = "surveyshort(quest0,quest1,quest2,quest3,quest4,user_key)"
    val mediumTableForm = "surveymedium(quest0,quest1,quest2,quest3,quest4,quest5,quest6,quest7,quest8,quest9,user_key)"
    val largeTableForm = "surveylong(quest0,quest1,quest2,quest3,quest4,quest5,quest6,quest7,quest8,quest9,quest10,quest11,quest12,quest13,quest14,quest15,quest16,quest17,quest18,quest19,user_key)"
    val updateUse = "first_name=?,last_name=?,userName=?,userPass=?"
